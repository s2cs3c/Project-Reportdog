export default {
    ...
    tooltip: {
        usersConnected: 'Users on the Project:',
        editAudit: 'Edit Project',
        downloadReport: 'Download Report',
        deleteAudit: 'Delete Project',
        removeAudit: 'Remove Project (Project will not be deleted)',
        topButtonSection: {
            submitReview: 'Mark project as ready for review',
            cancelReview: 'Make changes to the project',
            approve: 'Approve this project',
            removeApproval: 'Remove project approval',
            createRetest: 'Create a Retest for this Project',
            navigateRetest: 'Navigate to the Retest of this Project'
        },
        sortOptions: 'Sort Options',
        addToFindings: 'Add to Findings',
        edit: 'Edit',
        view: 'View',
        findAudits: 'Find Projects',
        delete: 'Delete',
        download: 'Download',
        retestSplitView: 'Enable split view with original Finding data',
        addAudit: 'Add Project',
    ...
    msg: {
        auditReviewUpdateOk: 'Project review status updated successfully',
        auditApprovalUpdateOk: 'Project approval updated successfully',
        auditUpdateOk: 'Project updated successfully',
        ...
        auditTypeNotSet: 'Project Type not set',
        ...
        vulnerabilityMergeOk: '<strong>{0}</strong> vulnerabilities merged successfully',
        selectAtLeast2Vulnerabilities: 'Please select at least 2 vulnerabilities to merge',
        confirmMerge: 'Confirm Merge',
        mergeVulnerabilitiesConfirm: '<strong>{0}</strong> vulnerabilities will be merged into a single new vulnerability.<br /><br /><strong>Warning:</strong> The original vulnerabilities will be deleted.',
        mergeError: 'Error merging vulnerabilities',
        findingsMergeOk: 'Findings merged successfully',
        selectAtLeast2Findings: 'Please select at least 2 findings to merge',
        mergeFindingsConfirm: '<strong>{0}</strong> findings will be merged into a single new finding.<br /><br /><strong>Warning:</strong> The original findings will be deleted.',
        nessusImportOk: '<strong>{0}</strong> vulnerabilities imported from Nessus',
        nessusImportAllExists: 'All <strong>{0}</strong> vulnerabilities already exist',
        nessusImportPartial: '<strong>{0}</strong> vulnerabilities imported<br /><strong>{1}</strong> already exist',
        nessusImportEmpty: 'No vulnerabilities found in Nessus file',
        nessusImportError: 'Error importing Nessus file',
        invalidNessusFile: 'Invalid file format. Please select a .nessus or .xml file',
        bulkApproveOk: '<strong>{0}</strong> vulnerabilities approved',
        bulkApproveConfirm: 'Approve selected vulnerabilities?',
        bulkApproveNotice: '<strong>{0}</strong> vulnerabilities will be approved',
        ...
        noAuditTypeForThisStage: 'No Assessments. Create a Project Type first'
    },
    err: {
    ...
    noAudit: 'No Project Types are defined.  Please create Project Types in ',
    auditTypes: 'Project Types',
    auditType: 'Project Type',
    searchFinds: 'Search Finding',
    myAudits: 'My Projects',
    usersConnected: 'Users Connected',
    awaitingMyReview: 'Awaiting my review',
    newAudit: 'New Project',
    search: 'Search',
    users: 'Users',
    auditNum1: 'Project',
    auditNums: 'Projects',
    resultsPerPage: 'Results per page:',
    createAudit: 'Create Project',
    name: 'Name',
    ...
    importNessus: 'Import Nessus',
    importNessusInfo: `Import vulnerabilities from a Nessus XML (.nessus) file.<br />
    This allows you to import vulnerabilities from Nessus scan results. Select the target language for imported vulnerabilities.`,
    importing: 'Importing',
    ...
    locale: 'Locale',
    auditTypesUsedInAudits: 'Project types used in Projects',
    languageUsedInAuditsAndVuls: 'Languages used in Projects and Vulnerabilities',
    addSections: 'Add Sections',
    hideBuiltInSections: 'Hide Built-in Sections',
    listOfAuditTypes: 'List of Project Types',
    editAuditTypes: 'Edit Project Types',
    ...
    createCustomSections: 'Create Custom Sections used in Projects',
    ...
    auditGeneral: 'Project General',
    auditFinding: 'Project Finding',
    auditSection: 'Project Section',
    ...
    reviews: 'Reviews',
    auditUpdateAfterApproval: 'Project Update After Approval',
    changeApproveBehaviorIfAuditUpdated: 'Changes the behavior for an approved project that gets updated. If a project is updated : ',
    ...
    mergeVulnerabilitiesInfoNew: `Select multiple vulnerabilities to merge them into a single new vulnerability.<br />
    All titles and descriptions will be combined. The highest CVSS, priority, and remediation complexity values will be used.`,
    mergedVulnerabilityTitle: 'New Vulnerability Title',
    selectVulnerabilitiesToMerge: 'Select Vulnerabilities to Merge',
    selected: 'selected',
    ...
    merge: 'Merge',
    mergeFindings: 'Merge Findings',
    mergeFindingsInfo: 'Select findings to merge into a single new finding. Titles and descriptions will be combined. The highest CVSS, priority, and remediation complexity values will be used.',
    mergedFindingTitle: 'New Finding Title',
    selectFindingsToMerge: 'Select Findings to Merge',
    goBack: 'Go back',
    ...
    defaultFieldsRequiredDescription: 'Manage requirement of default Fields in Projects',
    ...
    default: 'Default',
    audit: 'Project',
    originalAudit: 'Original Project',
    willBeRemoved: 'will be removed',
    auditPhase: 'Project Phase',
    upload: 'Upload',
    ...
    neededForAuditTypes: 'Needed for Project Types',
